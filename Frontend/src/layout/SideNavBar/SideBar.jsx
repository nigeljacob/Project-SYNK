...
import "./SideBar.css";
import { getStatus } from "../../utils/UserAccount";
    ...
    <>
      ...
      <div className="navBar">
        <div className="Profile">
            ...
            <div className="profilePicture">
              {user === null ? (
                ...
                <img
                  src={user.profile}
                  alt="profile"
                  className="tw-w-full tw-h-full tw-object-cover tw-rounded-[50%]"
                />
              )}
            </div>
          </div>
          ...
          <div className="title">
            <h2 id="userName">{props.user.displayName}</h2>
            {user != null ? (
              user.about != "" &&
              user.about != undefined &&
              user.about != null ? (
                <h4 id="title">{user.about.toUpperCase()}</h4>
              ) : null
            ) : null}
          </div>
          ...
          {newNotifications.length > 0 ? (
            <div className="notificationButton tw-relative">
              ...
              <div className="tw-w-[20px] tw-h-[20px] tw-bg-[#5BCEFF] tw-absolute tw-top-0 tw-mt-[-10px] tw-mr-[-10px] tw-right-0 tw-rounded-[50%] tw-flex tw-justify-center tw-items-center">
                <h3 className="tw-text-black tw-text-[12px]">
