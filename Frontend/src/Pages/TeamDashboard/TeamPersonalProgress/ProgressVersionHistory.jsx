              ...
              {versions.length > 0 ? (
                <div>
                  <div className='tw-w-full tw-flex tw-justify-center tw-items-center tw-mt-[10px] '>
                    <h3 className='tw-text-[18px]'>File version for <span className='tw-text-[#5BCEFF] tw-font-bold'>TASK {props.index + 1}</span></h3>
                  </div>
                        ...
                        index === selectedVersion ? (
                          <div className='tw-w-[90%] tw-bg-[#0B0B0B] tw-h-[80px] tw-my-[20px] version'>
                            <div className='tw-flex tw-items-center'>
                              ...
                              <h3 className='tw-text-[15px] tw-font-bold tw-ml-[10px]'>{version.date} at {version.time}</h3>
                            </div>
                            <p className='tw-text-[#A7A7A7] tw-ml-[10px]'>currently viewing version</p>
                          </div>
                        ) : (
                          <div className='tw-w-[90%] tw-h-[80px] tw-my-[20px] tw-px-[10px] tw-cursor-pointer' onClick={event => {handleSelectedVersion(index)}}>
                            <div className='tw-flex tw-items-center'>
                              <div className='tw-min-w-[10px] tw-min-h-[10px] tw-rounded-[50%] tw-bg-[#5BCEFF]'></div>
                              <h3 className='tw-text-[15px] tw-font-bold tw-ml-[10px]'>{version.date} at {version.time}</h3>
                            </div>
                            <p className='tw-text-[#A7A7A7] tw-ml-[10px]'>Click to view this version</p>
                          </div>
                        )
                      )
                    })}
