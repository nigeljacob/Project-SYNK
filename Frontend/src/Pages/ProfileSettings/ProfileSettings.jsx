...
import { updateProfileData } from "../../utils/UserAccount";
    ...
    <div className="tw-w-full tw-h-full tw-relative">
      <div className="tw-w-[300px] tw-bg-zinc-900 tw-absolute tw-right-0 tw-m-[20px] tw-rounded-[20px] sideBarOpened tw-flex tw-flex-col tw-items-center">
        <div className="profilePic tw-w-[85%] tw-bg-[#0B0B0B] tw-rounded-[20px] tw-h-[250px] tw-mt-[20px] tw-flex tw-items-center tw-justify-center tw-relative">
            ...
            <>
              {profilePic === props.user.photoURL ? (
                <img
                  src={profilePic}
                  alt="profilePic"
                  className="tw-rounded-[20px] tw-w-[100%] tw-h-[250px] tw-snap-center tw-object-cover"
                />
              ) : (
                <img
                  src={tempProfilePic}
              ...
              {isLoading ? <CircularProgress className="tw-absolute" /> : null}
            </>
          ) : (
            <>
              <h1 className="tw-text-[150px] tw-font-extrabold tw-select-none">
                {userName[0]}
              </h1>
            </>
          )}
          ...
          <div
            className="tw-absolute tw-p-[10px] tw-bg-[#272727] tw-rounded-[10px] tw-bottom-0 tw-right-0 tw-m-[10px] tw-cursor-pointer"
            onClick={(event) => {
              handleClick();
            }}
          >
        ...
        <div className="tw-h-[55%] tw-max-h-[55%] tw-w-[90%] tw-overflow-y-scroll">
          <div className="info tw-w-[90%] tw-mt-[20px] tw-ml-[20px]">
            ...
            <p className="tw-text-light tw-text-[13px] tw-text-[#A7A7A7]">
              Name
            </p>
          </div>
        ...
        {isUploading ? (
          ...
          <div
            className="tw-absolute tw-bottom-0 tw-w-[90%] tw-py-[7px] tw-bg-[#5BCEFF] tw-rounded-[10px] tw-mb-[15px] tw-flex tw-items-center tw-justify-center tw-text-black tw-cursor-pointer"
            onClick={(event) => {
              handleUpdateProfile();
            }}
          >
      ...
      <div className="tw-w-[70%] tw-ml-[10px] tw-justify-center tw-flex tw-mt-[30px]">
        <form className="tw-w-[90%]">
          ...
          <input
            ...
            name="userName"
            id="userName"
            className="tw-bg-[#0B0B0B] tw-text-white tw-border-none"
            value={userName}
            onChange={(event) => {
          ...
          <h4 className="tw-text-[15px] tw-ml-[5px] tw-mt-[15px]">
            Phone Number
          </h4>
          <input
            type="tel"
